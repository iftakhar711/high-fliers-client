                ...
                <div className="relative z-[1] block rounded-lg bg-[hsla(0,0%,100%,0.55)] px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] backdrop-blur-[30px] dark:bg-[hsla(0,0%,5%,0.55)] dark:shadow-black/20 md:px-12 lg:-mr-14">
                  ...
                  <p className="mb-8 pb-2 text-neutral-500 dark:text-neutral-300 lg:pb-0 text-justify">
                    <span className=" text-xl font-semibold text-sky-600 ">
                      How do we make a difference- <br />
                    </span>
                    We are a professional student consulting firm, dedicated to
                    providing the best solutions to students seeking higher
                    study abroad. We strive to create opportunities for students
                    because we believe everyone should have access to quality
                    higher education. <br /> <br />
                    With many of our streams directly linking to the permanent
                    residence route, we help you not only get your student visa
                    application sorted, but also ensure better career, as
                    opposed to just your studies. It has started its journey
                    since 2004 and ever since it has worked with several
                    students with a 99% success rate. Every year thousands of
                    students apply in the top universities all over the country
                    but due to lack of expertise fail to get admission in the
                    desired universities. Thus, we are here with our expert team
                    to help you, and provide total guidance throughout your
                    journey of studying abroad with scholarships. We are
                    extremely professional when it comes to our
                    responsibilities. But we deal with our clients with utmost
                    individuality and care in order to enhance transparency of
                    our processing and keep them involved throughout the whole
                    journey.
                  </p>
