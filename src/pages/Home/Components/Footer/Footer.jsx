...
window.scrollTo({
  ...
  return (
    <>
      <div className="bg-sky-700  relative py-2 text-white  ">
      ...
      <div className="flex flex-col space-y-6 text-sm  ">
         ...
         <h1 className=''> Rajuk Trade Centre, New Airport Road, Nikunjo-1, Khilkhet, Dhaka, Bangladesh.</h1>
         </div>

         <div className=' flex gap-3'>
          <PiPhoneCallLight></PiPhoneCallLight>
          <h1 > +880 1869-653084 </h1>
         </div>
         ...
         <HiOutlineMail></HiOutlineMail>
          <h1 > highfliersglobal.edu@gmail.com </h1>
         </div>

         <div className=' flex gap-3'>
          <CiTimer></CiTimer>
          <h1 >Saturday - Thursday: 10:00 - 5:30
               <br /> Friday: Closed  </h1>
         </div>
          ...
          <div className="flex flex-col space-y-3 lg:px-20">
            ...
            <div className="flex flex-col space-y-3 text-sm text-slate-300">
              <Link onClick={top} to='/soon' className="hover:text-slate-600 ">Apply Now</Link>
              <Link onClick={top} to='/contuctus' className="hover:text-slate-600 " >Contact Us</Link>
              <Link onClick={top} to='/about' className="hover:text-slate-600">About Us</Link>
              <Link onClick={top} to='/service' className="hover:text-slate-600">Service</Link>
              <Link onClick={top} to='/soon' className="hover:text-slate-600">Article</Link>
            </div>
          </div>
          <div className="flex flex-col space-y-3 ">
            <h2 className="font-bold">SUPPORT</h2>
            <div className="flex flex-col space-y-3 text-sm text-slate-300">
              <Link href="#"  className="hover:text-slate-600">Report a Bug</Link>
              <Link href="#"  className="hover:text-slate-600">FAQS</Link>
            </div>
          </div>
        ...
        <div className="px-3 max-w-xs sm:max-w-sm md:max-w-md lg:max-w-6xl mx-auto grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-3 ">
          <div className=" flex gap-10 mt-14">
            <Link target="blank" to="https://www.facebook.com/profile.php?id=61552573325783&mibextid=LQQJ4d"><AiOutlineFacebook></AiOutlineFacebook></Link>
